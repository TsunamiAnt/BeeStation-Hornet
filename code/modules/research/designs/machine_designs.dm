...
/datum/design/board/law_server
	name = "Machine Design (AI Law Server)"
	desc = "The circuit board for an AI law server."
	id = "law_server"
	build_path = /obj/item/circuitboard/machine/law_server
